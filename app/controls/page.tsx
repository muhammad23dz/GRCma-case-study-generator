...
export default function ControlsPage() {
    ...
    // Move useState to top level - unconditionally called
    ...
    // Calculate filtered controls
    const filteredControls = controls.filter(control => {
        if (activeTab === 'all') return true;
        return control.controlType === activeTab;
    });
                    ...
                    <div className="flex space-x-2 mb-8 border-b border-white/10">
                        {['all', 'preventive', 'detective', 'corrective', 'directive'].map((tab) => (
                            ...
                            >
                                ...
                                {activeTab === tab && (
                                    <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-emerald-400 transition-all" />
                                )}
                            </button>
                        ))}
                    </div>
