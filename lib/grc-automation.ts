...
export async function assessVendorRisk(
    ...
    console.log(`[GRC Automation] Created Supply Chain Risk for vendor: ${vendorName} in org ${organizationId}`);
}
    ...
    for (const risk of potentialRisks) {
        ...
        await prisma.risk.update({
            ...
            data: {
                ...
                score: newLikelihood * risk.impact,
...
export async function createChangeRisk(
    ...
    await prisma.changeRisk.create({
        data: {
            ...
            description: `Automated risk for change ${change.changeNumber}`,
            likelihood,
            impact,
