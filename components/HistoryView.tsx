                        ...
                        <div className="flex justify-between items-start">
                            ...
                            <button
                                onClick={(e) => {
                                    ...
                                    const confirmed = window.confirm(`Are you sure you want to delete report ${report.id}?`);
                                ...
                                className="ml-4 p-3 text-red-400 hover:text-white hover:bg-red-600 rounded-lg transition-all cursor-pointer border border-red-500/30 hover:border-red-500"
                                title="Delete report"
                                type="button"
