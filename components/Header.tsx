                ...
                <div className="flex items-center gap-6">
                    <nav>
                        <ul className="flex space-x-2 text-sm font-medium">
                            ...
                            <li><Link href="/mapping" className="hover:text-pink-400 transition-colors px-3 py-2 rounded-lg hover:bg-pink-500/10 border border-transparent hover:border-pink-500/30 block">M mapping</Link></li>
